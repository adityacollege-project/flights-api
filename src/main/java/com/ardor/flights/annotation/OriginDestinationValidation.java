...
import com.ardor.flights.annotation.implementations.OriginDestinationValidator;
...
/**
 * OriginDestinationValidation is a custom annotation used for validating origin-destination details
 * in a flight search request. It ensures that the provided origin-destination details meet certain
 * criteria using the OriginDestinationValidator class. The annotation can be applied to fields,
 * parameters, or types (classes).
 *
 * @author mkkumar
 */
@Documented
@Constraint(validatedBy = OriginDestinationValidator.class)
@Target({ElementType.FIELD, ElementType.PARAMETER, ElementType.TYPE})
@Retention(RetentionPolicy.RUNTIME)
public @interface OriginDestinationValidation {
