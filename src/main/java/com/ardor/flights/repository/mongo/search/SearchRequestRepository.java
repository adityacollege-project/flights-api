...
@Repository
public interface SearchRequestRepository extends MongoRepository<SearchRequestEntity, String> {

  List<SearchRequestEntity> findBySearchKeyOrderByCreatedDesc(String searchKey);

  default SearchRequestEntity findLatestBySearchKey(String searchKey) {
    List<SearchRequestEntity> resultList = findBySearchKeyOrderByCreatedDesc(searchKey);
