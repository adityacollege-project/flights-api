...
@Repository
public interface TransactionDetailRepository extends JpaRepository<AirTransactionDetail, Long> {

  List<AirTransactionDetail> findByAirTransactionId(String airTransactionId);
